 ...
 */
static void transform(cc_tiger_ctx *hd, unsigned char *data)
{
...
static void tiger_init(cc_tiger_ctx *hd)
{
...
static void tiger_update(cc_tiger_ctx *hd, unsigned char *inbuf, size_t inlen)
{
