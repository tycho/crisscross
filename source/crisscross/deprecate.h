...
#define _CC_DEPRECATE_SLOW(x)                    _CC_DEPRECATE_TEXT("When used, this function or class can result in a " x " slowdown in execution speed. Be sure to check the CrissCross documentation.")
#else
