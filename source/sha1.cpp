...
namespace
{
	...
	void SHA1Init(cc_sha1_ctx * context)
	{
	...
	void SHA1Update(cc_sha1_ctx * context, unsigned char * data, unsigned int len)
	{
			unsigned int i, j;
	...
	void SHA1Final(unsigned char digest[20], cc_sha1_ctx * context)
	{
			unsigned long i, j;
