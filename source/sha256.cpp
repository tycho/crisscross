...
#define SHA256_EXP(a, b, c, d, e, f, g, h, j)               \
	...
	void sha256_init(cc_sha256_ctx *ctx)
	{
#ifndef UNROLL_LOOPS
		int i;
		for (i = 0; i < 8; i++) {
	...
	void sha256_update(cc_sha256_ctx *ctx, const unsigned char *message, unsigned int len)
	{
	...
	void sha256_final(cc_sha256_ctx *ctx, unsigned char *digest)
	{
		unsigned int block_nb;
		unsigned int pm_len;
		unsigned int len_b;
